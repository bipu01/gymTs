...
const EnrollNow = () => {
  ...
  return (
    <div className={`${requiresMargin} pb-20vh h-100vh py-10vh`}>
      ...
      <div className="flex flex-col border-solid rounded-2xl border-2 border-white50 p-2 py-8 xmd:py-12 xmd:p-10  gap-8 xmd:gap-12 ">
        ...
        <div id="monthlyProgram">
          ...
          <div id="monthlyProgramMenu" className={`${isMonthlyOpen?'h-60 p-4':'h-0 p-0'} gap-4 overflow-clip menuPanel flex flex-col transition-all duration-150 mt-1 w-100% border-solid border-1px border-y-white80 border-x-transparent bg-menuBg`}>
            <ProgramMenu/>
          </div>
        </div>
