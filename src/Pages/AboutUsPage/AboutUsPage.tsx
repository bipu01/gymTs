...
const AboutUsPage = () => {
  return (
    ...
    <div>
      ...
      <div className={`${marginForSubTexts} my-5vh`}>
        <h1 className={` text-md xmd:text-lg font-bold opacity-90 tracking-widest`}> Flexible Membership Options:</h1>
        ...
        <Link to={"/enrollPage"}>
          <div className="flex mt-2 items-center text-xs xmd:text-sm gap-2">
            <p className=" tracking-wide underline opacity-70 hover:opacity-100">
      ...
      <div className={`${marginForSubTexts} my-5vh`}>
        <h1 className={` text-md xmd:text-lg font-bold opacity-90 tracking-widest`}> Variety of classes:</h1>
        <p className={`mt-4 opacity-70 text-xs xmd:text-sm xmd:w-40vw`}>
      ...
      <div className={`${marginForSubTexts} my-5vh`}>
        <h1 className={` text-md xmd:text-lg font-bold opacity-90 tracking-widest`}> Community experience:</h1>
        <p className={`mt-4 opacity-70 text-xs xmd:text-sm xmd:w-40vw`}>
